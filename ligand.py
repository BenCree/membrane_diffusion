...
md_ligand_pos = md_ligand_pos + [0,0,6] * unit.nanometers
...
for i in range(n):
    ...
    md_ligand_pos_rand = md_ligand_pos + [x,y,z] * unit.nanometers
    modeller.add(omm_top, md_ligand_pos_rand)

from simtk.openmm.app import PDBFile

# assuming 'modeller' is your OpenMM Modeller instance
pdb_filename = 'output_model.pdb'

# write the model to a PDB file
PDBFile.writeFile(modeller.topology, modeller.positions, open(pdb_filename, 'w'))
